const CAPABILITIES = [
  {
    ...
    icon: (
      <svg className="h-9 w-9" viewBox="0 0 36 36" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden>
    ...
    <section className="bg-deep-green py-20 text-white md:py-24">
      <div className="mx-auto max-w-container px-6">
        ...
        <p className="mb-12 max-w-lg text-lg text-white/70">
          No gatekeepers. No editorial review. Weekly cycles give every product a clean shot at the
          top — whether you ship from Bengaluru, Indore, or a hostel room in Pune.
        </p>
